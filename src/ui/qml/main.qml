...
ApplicationWindow {
    ...
    RowLayout {
        ...
        Item {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text {
                                text: editor.workspaceName.toUpperCase()
                                color: "#8e9499"
                                font.pixelSize: 11
                            ...
                            Rectangle {
                                width: 20
                                height: 20
                                color: refreshMouseArea.containsMouse ? "#2c3135" : "transparent"
                                radius: 2
                    ...
                    ScrollView {
                        ...
                        contentWidth: fileListView.width
                        contentHeight: fileListView.contentHeight
                        ...
                        ListView {
                            ...
                            delegate: Rectangle {
                                ...
                                Row {
                                    ...
                                    spacing: 6
                                    anchors.left: parent.left
                                    anchors.leftMargin: 10 + (modelData.level * 12)
                                    ...
                                    Text {
                                        ...
                                        anchors.verticalCenter: parent.verticalCenter
                                        elide: Text.ElideRight
                                        width: fileListView.width - (10 + (modelData.level * 12) + 30)
                                    }
                                }
                            ...
                            // Placeholder cuando no hay workspace
                            Component.onCompleted: {
                                if (editor.workspaceFolder === "") {
                                    // Mostrar mensaje de "Open Folder"
                                }
                            }
                        }
                    }
            ...
            // Área para redimensionar (mantener igual)
            Rectangle {
                id: resizeHandle
                anchors.right: parent.right
            ...
            RowLayout {
                ...
                ScrollView {
                    ...
                    TextArea {
                        ...
                        // Manejar cambios del usuario
                        onTextChanged: {
                            if (!internalChange && editor.currentDocument) {
                                // Usuario editó el texto
                                editor.currentDocument.setText(text)
                            }
                        ...
                        // Actualizar cuando el backend cambia (undo/redo)
                        Connections {
